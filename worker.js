...
userQueue.process(async (job, done) => {
  ...
  try {
    const mailSubject = 'Welcome to ALX-Files_Manager by Philip';
    const mailContent = [
      '<div>',
      '<h3>Hello {{user.name}},</h3>',
      'Welcome to <a href="https://github.com/Donphili/alx-files_manager">',
      'ALX-Files_Manager</a>, ',
      'a simple file management API built with Node.js by ',
      '<a href="https://github.com/Donphili">Onyejekwe Philip</a>. ',
      'We hope is as you expected.',
      '</div>',
    ].join('');
